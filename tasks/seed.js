...
const main = async () => {
	try {
		...
		const plan1_node = [{ position: "Beijing", arrival_time: "10/31/2020 6:00", departure_time: "10/31/2020 18:00", recommended_restaurants: ["871982708es312sesde3414"], recommended_residence: ["321982708es312sesde3414"] }];
